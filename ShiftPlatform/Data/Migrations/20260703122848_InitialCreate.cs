        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FontFamily = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "Aptos"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsStaff = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProvisioningRecords_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RegistrationSubmissions_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeatsApplied = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SeatPurchases_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    RegistrationSubmissionId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    StripePaymentIntentId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Amount = table.Column<long>(type: "bigint", nullable: false),
                    Currency = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentRecords_RegistrationSubmissions_RegistrationSubmissionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestingAssignmentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TargetUserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    TargetAssignmentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SwapRequests_ShiftAssignments_TargetAssignmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentRecords_RegistrationSubmissionId",
                table: "PaymentRecords",
                column: "RegistrationSubmissionId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentRecords_StripePaymentIntentId",
                table: "PaymentRecords",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProvisioningRecords_TenantId",
                table: "ProvisioningRecords",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_RegistrationSubmissions_TenantId",
                table: "RegistrationSubmissions",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_SeatPurchases_StripePaymentIntentId",
                table: "SeatPurchases",
                column: "StripePaymentIntentId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SeatPurchases_TenantId",
                table: "SeatPurchases",
                column: "TenantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SwapRequests_RequestingAssignmentId",
                table: "SwapRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SwapRequests_TargetAssignmentId",
                table: "SwapRequests",
